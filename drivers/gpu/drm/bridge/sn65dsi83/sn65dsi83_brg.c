...
static int sn65dsi83_brg_configure(struct sn65dsi83_brg *brg)
{
    ...
    dev_info(&client->dev, "PIX clock [ %lu ] Hz\n", PIXCLK);
    ...
    if  ((25000000 <= PIXCLK) && (PIXCLK < 37500000))
        ...
        regval = sn65dsi83_calk_clk_range(0x01, 0x05, 37500000, 25000000, PIXCLK);
    ...
    SN65DSI83_WRITE(SN65DSI83_CHB_DSI_CLK_RNG,0x00); // Channel B
    ...
    /* Video formats */
    regval = SN65DSI83_READ(SN65DSI83_LVDS_MODE) & (1<< 4); //preserve bit 4
    ...
    SN65DSI83_WRITE(SN65DSI83_LVDS_SIGN,0b1000000); //CHA_LVDS_VOCM set to 1

    SN65DSI83_WRITE(SN65DSI83_LVDS_TERM,0x03);
    //SN65DSI83_WRITE(SN65DSI83_LVDS_CM_ADJ,0x00);
    SN65DSI83_WRITE(SN65DSI83_LVDS_CM_ADJ,0b10000);

    /* Configure sync delay to minimal allowed value */
    SN65DSI83_WRITE(SN65DSI83_CHA_SYNC_DELAY_LO,0x21); //0x21
    ...
    SN65DSI83_WRITE(SN65DSI83_TEST_PATTERN,0x00); // 0x10 to enable test pattern
